...
function generateTable() {
  ...
  if ($('.finaltable').length > 0) {
    ...
    ***********************************************/
    ...
    var tr = document.createElement('TR');
    tr.innerHTML = '<th class="text-center">Total lectures of Theory Assigned</th><th class="text-center">Total lectures of Pracs Assigned</th><th class="text-center">Total lectures of Project Assigned</th>'
